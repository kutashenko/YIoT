/*
 * Generated by gdbus-codegen 2.58.3 from bluez.xml. DO NOT EDIT.
 *
...
#include "/home/roman/Work/kutashenko/ble-provision/service/linux/src/ble/bluez-glue.h"
  ...
  if (!_g_value_equal (value, &skeleton->priv->properties[prop_id - 1]))
    {
      if (g_dbus_interface_skeleton_get_connection (G_DBUS_INTERFACE_SKELETON (skeleton)) != NULL)
        _gatt_service1_schedule_emit_changed (skeleton, (const _ExtendedGDBusPropertyInfo *) _gatt_service1_property_info_pointers[prop_id - 1], prop_id, &skeleton->priv->properties[prop_id - 1]);
  ...
  GParamSpec   *pspec)
{
  ...
  if (!_g_value_equal (value, &skeleton->priv->properties[prop_id - 1]))
    {
      if (g_dbus_interface_skeleton_get_connection (G_DBUS_INTERFACE_SKELETON (skeleton)) != NULL)
        _gatt_characteristic1_schedule_emit_changed (skeleton, (const _ExtendedGDBusPropertyInfo *) _gatt_characteristic1_property_info_pointers[prop_id - 1], prop_id, &skeleton->priv->properties[prop_id - 1]);
      g_value_copy (value, &skeleton->priv->properties[prop_id - 1]);
      g_object_notify_by_pspec (object, pspec);
    }
  g_mutex_unlock (&skeleton->priv->lock);
...
static const GDBusPropertyInfo * const _gatt_descriptor1_property_info_pointers[] =
{
  ...
  &_gatt_descriptor1_property_info_flags.parent_struct,
  NULL
};
  ...
  GParamSpec   *pspec)
{
  ...
  if (!_g_value_equal (value, &skeleton->priv->properties[prop_id - 1]))
    {
      if (g_dbus_interface_skeleton_get_connection (G_DBUS_INTERFACE_SKELETON (skeleton)) != NULL)
        _gatt_descriptor1_schedule_emit_changed (skeleton, (const _ExtendedGDBusPropertyInfo *) _gatt_descriptor1_property_info_pointers[prop_id - 1], prop_id, &skeleton->priv->properties[prop_id - 1]);
      g_value_copy (value, &skeleton->priv->properties[prop_id - 1]);
      g_object_notify_by_pspec (object, pspec);
    }
  g_mutex_unlock (&skeleton->priv->lock);
  ...
  GParamSpec   *pspec)
{
  ...
  if (!_g_value_equal (value, &skeleton->priv->properties[prop_id - 1]))
    {
      if (g_dbus_interface_skeleton_get_connection (G_DBUS_INTERFACE_SKELETON (skeleton)) != NULL)
        _leadvertisement1_schedule_emit_changed (skeleton, (const _ExtendedGDBusPropertyInfo *) _leadvertisement1_property_info_pointers[prop_id - 1], prop_id, &skeleton->priv->properties[prop_id - 1]);
      g_value_copy (value, &skeleton->priv->properties[prop_id - 1]);
      g_object_notify_by_pspec (object, pspec);
    }
  g_mutex_unlock (&skeleton->priv->lock);
